...
func (fes *APIServer) _balanceEntryToResponse(
	...
	utxoView *lib.UtxoView) *BalanceEntryResponse {
...
func (fes *APIServer) _profileEntryToResponse(profileEntry *lib.ProfileEntry, utxoView *lib.UtxoView) *ProfileEntryResponse {
	...
	verifiedUsernameMap := fes.VerifiedUsernameMap
...
func (fes *APIServer) augmentProfileEntry(
	...
	for _, profilePostEntry := range profilePostsFound {
		profilePostRes, err := fes._postEntryToResponse(profilePostEntry, addGlobalFeedBool, utxoView, readerPK, 2)
...
func (fes *APIServer) GetNotifications(ww http.ResponseWriter, req *http.Request) {
	...
	addPostForHash := func(postHashHex string, readerPK []byte) {
		...
		postEntryResponse, err := fes._postEntryToResponse(postEntry, false, utxoView, userPublicKeyBytes, 2)
		if err != nil {
			return
		}
