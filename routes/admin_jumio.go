...
func (fes *APIServer) AdminResetJumioForPublicKey(ww http.ResponseWriter, req *http.Request) {
	...
	if userMetadata.JumioDocumentKey != nil {
		if err = fes.GlobalState.GlobalStateDelete(userMetadata.JumioDocumentKey); err != nil {
	...
	keys, _, err := fes.GlobalState.GlobalStateSeek(prefix, prefix, maxKeyLen, 100, true, true)
	if err != nil {
