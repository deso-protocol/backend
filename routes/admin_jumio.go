...
func (fes *APIServer) AdminJumioCallback(ww http.ResponseWriter, req *http.Request) {
	...
	if _, exists := country_codes.Alpha3CountryCodes[requestData.CountryAlpha3]; requestData.CountryAlpha3 != "" && !exists {
...
func (fes *APIServer) AdminUpdateJumioCountrySignUpBonus(ww http.ResponseWriter, req *http.Request) {
	...
	var countryCodeDetails country_codes.Alpha3CountryCodeDetails
	var exists bool
	// Validate the country code
	if countryCodeDetails, exists = country_codes.Alpha3CountryCodes[requestData.CountryCode]; !exists {
...
type CountrySignUpBonusResponse struct {
	CountryLevelSignUpBonus CountryLevelSignUpBonus
	CountryCodeDetails      country_codes.Alpha3CountryCodeDetails
}
...
func (fes *APIServer) SetAllCountrySignUpBonusMetadata() {
	for countryCode, countryDetails := range country_codes.Alpha3CountryCodes {
...
func (fes *APIServer) SetSingleCountrySignUpBonus(countryDetails country_codes.Alpha3CountryCodeDetails,
...
func (fes *APIServer) GetSingleCountrySignUpBonus(countryCode string) CountryLevelSignUpBonus {
	...
	countryCodeDetails := country_codes.Alpha3CountryCodes[strings.ToUpper(countryCode)]
